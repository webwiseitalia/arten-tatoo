      ...
      <div className="flex flex-col lg:flex-row gap-0">
        ...
        <div className="contatti-form lg:w-[65%] px-5 sm:px-8 md:px-12 lg:px-20 lg:pr-16 border-t border-[var(--charcoal)] pt-10" style={{ opacity: 0 }}>
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button type="submit" className="inline-flex items-center gap-3 px-10 py-4 bg-[var(--gold)] text-[var(--black)] t-mono text-[13px] uppercase tracking-[0.15em] hover:bg-[var(--cream)] transition-colors duration-500 mt-4">
        ...
        <div className="contatti-sidebar lg:w-[35%] lg:sticky lg:top-24 lg:self-start px-5 sm:px-8 lg:px-10 py-10 lg:border-l border-t lg:border-t-0 border-[var(--charcoal)]" style={{ opacity: 0 }}>
          <div className="space-y-10">
            <div>
              <span className="t-mono text-[12px] text-[var(--muted)] block mb-4">Contatto diretto</span>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="t-mono text-[12px] text-[var(--muted)]">Via Badetto 60, Ceto (BS)</p>
                </div>
                <div>
                  <p className="text-[var(--cream)] text-sm" style={{ fontFamily: 'var(--sans)' }}>Studio di Sonico</p>
                  <p className="t-mono text-[12px] text-[var(--muted)]">Via Camiasco 1, Sonico (BS)</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-[var(--charcoal)]">
              ...
              <span className="t-mono text-[12px] text-[var(--gold)] mt-4 block">— Marco Leoni</span>
            </div>
          </div>
        </div>
      </div>
