    ...
    <footer ref={footerRef} className="border-t border-[var(--charcoal)]">
      ...
      <div className="footer-cta px-5 sm:px-8 md:px-12 lg:px-20 py-[12vh] sm:py-[16vh]" style={{ opacity: 0 }}>
        ...
        <a
          ...
          className="inline-flex items-center gap-3 mt-12 px-10 py-5 bg-[var(--gold)] text-[var(--black)] t-mono text-[13px] uppercase tracking-[0.15em] hover:bg-[var(--cream)] transition-colors duration-500"
        >
      ...
      <div className="border-t border-[var(--charcoal)] px-5 sm:px-8 md:px-12 lg:px-20 py-12 sm:py-16">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-0">
          ...
          <div className="lg:w-[30%]">
            ...
            <p className="t-mono text-[12px] text-[var(--muted)] leading-relaxed mt-4">
          ...
          <div className="lg:w-[25%]">
            <span className="t-mono text-[12px] text-[var(--muted)] block mb-4">Navigazione</span>
          ...
          <div className="lg:w-[20%]">
            <span className="t-mono text-[12px] text-[var(--muted)] block mb-4">Sedi</span>
            <div className="space-y-3">
              <div>
                <p className="text-[var(--cream)] text-sm" style={{ fontFamily: 'var(--sans)' }}>Ceto</p>
                <p className="t-mono text-[12px] text-[var(--muted)]">Via Badetto 60</p>
              </div>
              <div>
                <p className="text-[var(--cream)] text-sm" style={{ fontFamily: 'var(--sans)' }}>Sonico</p>
                <p className="t-mono text-[12px] text-[var(--muted)]">Via Camiasco 1</p>
              </div>
            </div>
          </div>
          ...
          {/* Social — 25% */}
          <div className="lg:w-[25%]">
            <span className="t-mono text-[12px] text-[var(--muted)] block mb-4">Social</span>
      ...
      <div className="border-t border-[var(--charcoal)]/50 px-5 sm:px-8 md:px-12 lg:px-20 py-6 flex flex-col sm:flex-row justify-between items-center gap-3">
        <p className="t-mono text-[12px] text-[var(--muted)]">
          © {new Date().getFullYear()} ARTEN | La Bottega del Tattoo
        </p>
        <div className="flex gap-6">
          <a href="#" className="t-mono text-[12px] text-[var(--muted)] hover:text-[var(--gold)] transition-colors">Privacy</a>
          <a href="#" className="t-mono text-[12px] text-[var(--muted)] hover:text-[var(--gold)] transition-colors">Cookie</a>
        </div>
      </div>
    </footer>
  )
