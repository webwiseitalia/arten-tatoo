  ...
  return (
    <section ref={sectionRef} id="hero" className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-end pb-[12vh] sm:pb-[15vh] px-5 sm:px-8 md:px-12 lg:px-20">
        ...
        <div ref={ctaRef} className="flex flex-wrap gap-5 mt-10 sm:mt-14 ml-0 sm:ml-[8vw]">
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-[var(--gold)] text-[var(--black)] t-mono text-[13px] uppercase tracking-[0.15em] hover:bg-[var(--cream)] transition-colors duration-500"
          >
          ...
          <a
            href="#artisti"
            className="inline-flex items-center gap-3 px-8 py-4 border border-[var(--cream)]/20 text-[var(--cream)] t-mono text-[13px] uppercase tracking-[0.15em] hover:border-[var(--gold)] hover:text-[var(--gold)] transition-all duration-500"
          >
            Scopri gli artisti
          </a>
        </div>
      ...
      <div className="absolute bottom-8 right-8 sm:right-12 flex items-center gap-3 opacity-40">
        <span className="t-mono text-[12px]">scroll</span>
